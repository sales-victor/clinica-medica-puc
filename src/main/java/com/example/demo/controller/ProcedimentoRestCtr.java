...
public class ProcedimentoRestCtr {
	...
	@PutMapping("/exame/update")
	public Retorno editarExame(@RequestBody ParamsExameDTO paramsExameDTO) {
		return procedimentoService.editarExame(paramsExameDTO);	
	}
